  ...
  tabsetPanel(
    ...
    tabPanel("About", 
             ...
             mainPanel( "The purpose of this app to explore data relative to the median lifespans of different zoo animals. This app provides a platform to explore and visualize the data, fit three different supervised learning models to the data, and investigate and subset the actual data itself.",
                        ...
                        uiOutput("link2"),
                        br(),
                        "The purpose of this page is to give the user a sense of what data will be used and the overall goal of the app. The second page will provide the user with an interactive platform for data exploration. Bar plots, histograms, and density plots will be available to the user, along with subsetting data tables and mean values presented. The third page allows the user to fit three different supervised learning methods: a multiple linear regression, regression tree, and random forest model. Within this page, there are separate tabs for information on the different models, model fits, and predicted values. The last and final page gives the user direct access to the data set. The user is able to subset and save the data here.",
                        br(),
                        br(),
                        "Here is a fun picture of my favorite animal!",
                        br(),
                        br(),
             ...
             tabsetPanel(
               ...
               tabPanel("Model Fitting", 
                        ...
                        sidebarPanel(
                          ...
                          br(),
                          br(),
                          em("If an error is presented for Taxon Class, just press the button again! This is from the random split of training and test data."),
                          br(),
                          h3("Model Statistics!"),
